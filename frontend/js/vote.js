...
async function loadBallot() {
    ...
    try {
        ...
        // Set header info
        document.getElementById('ballot-title').textContent = election.title;
        document.getElementById('ballot-desc').textContent = election.description || '';
        document.getElementById('ballot-time').textContent =
            `Voting ends: ${formatDate(election.end_time)}`;
